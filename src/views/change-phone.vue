    ...
    <div>
        ...
        <div class="wrapper">
            ...
            <div class="item">
                ...
                <div class="c-pnone">
                    <input type="tel" v-model="phoneNum" maxlength="11" disabled="disabled">
                </div>
        ...
        <mt-button size="large" class="r" @click="next">下一步</mt-button>
    </div>
</template>
<script>
    ...
    export default {
        data() {
            return {
                phoneNum: this.$store.state.account_number,
                code: "",
                tcode: "",
                sendAuthCode: true,
                auth_time: ""
        ...
        created() {
            this.phoneNum =  this.$store.state.account_number;
        },
        methods: {
            ...
            next() {
                ...
                if (this.code != this.tcode) {//手机号不合法
