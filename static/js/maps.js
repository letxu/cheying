(function(window) {
        ...
        if (!AMapUI || !AMapUI.requirejs) {
            ...
            function(global, setTimeout) {
                ...
                function mixin(e, t, r, n) {
                    return t && eachProp(t,
                    function(t, i) { ! r && hasProp(e, i) || (!n || "object" != typeof t || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[i] = t: (e[i] || (e[i] = {}), mixin(e[i], t, r, n)))
                    }),
                    e
                }
                function bind(e, t) {
                ...
                function newContext(e) {
                    ...
                    function a(e, t, n, i) {
                        ...
                        l = !0,
                        h = "";
                        return e || (l = !1, e = "_@r" + (C += 1)),
                        c = o(e),
                        f = c[0],
                        e = c[1],
                        f && (f = r(f, p, i), s = getOwn(k, f)),
                        e && (f ? h = s && s.normalize ? s.normalize(e,
                        function(e) {
                            return r(e, p, i)
                        }) : e.indexOf("!") === -1 ? r(e, p, i) : e: (h = r(e, p, i), c = o(h), f = c[0], h = c[1], n = !0, a = q.nameToUrl(h))),
                    ...
                    function d(e, t, r) {
                        var n = e.map.id;
                        e.error ? e.emit("error", e.error) : (t[n] = !0, each(e.depMaps,
                        function(n, i) {
                            var o = n.id,
                            a = getOwn(M, o); ! a || e.depMatched[i] || r[o] || (getOwn(t, o) ? (e.defineDep(i, k[o]), e.check()) : d(a, t, r))
                        }), r[n] = !0)
                    }
                    function l() {
                        ...
                        if (!x) {
                            ...
                            function(e) {
                                var r = e.map,
                                c = r.id;
                                if (e.enabled && (r.isDefine || s.push(e), !e.error)) if (!e.inited && o) i(c) ? (t = !0, u = !0) : (a.push(c), n(c));
                    ...
                    b.prototype = {
                        ...
                        callPlugin: function() {
                            ...
                            function(n) {
                                ...
                                return this.map.unnormalized ? (n.normalize && (l = n.normalize(l,
                                function(e) {
                                    return r(e, h, !0)
                                ...
                                })), f = getOwn(M, o.id), void(f && (this.depMaps.push(o), this.events.error && f.on("error", bind(this,
                                function(e) {
                                    this.emit("error", e)
                                })), f.enable()))) : d ? (this.map.url = q.nameToUrl(d), void this.load()) : (i = bind(this,
                                function(e) {
                                    this.init([],
                                    function() {
                                        return e
                    ...
                    q = {
                        ...
                        makeRequire: function(t, i) {
                            function o(r, n, u) {
                                ...
                                "string" == typeof r ? isFunction(n) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(y, r) ? y[r](M[t.id]) : req.get ? req.get(q, r, t, o) : (p = a(r, t, !1, !0), f = p.id, hasProp(k, f) ? k[f] : c(makeError("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + e + (t ? "": ". Use require([])")))) : (v(), q.nextTick(function() {
                                    v(),
                                    d = s(a(null, t)),
                                    d.skipMap = i.skipMap,
                                    d.init(r, n, u, {
                            ...
                            mixin(o, {
                                ...
                                toUrl: function(e) {
                                    ...
                                    o = e.split("/")[0],
                                    a = "." === o || ".." === o;
                                    return i !== -1 && (!a || i > 1) && (n = e.substring(i, e.length), e = e.substring(0, i)),
                            ...
                            t || (o.undef = function(e) {
                                ...
                                i && (i.events.defined && (A[e] = i.events), p(e))
                            }),
                            o
                        },
                        enable: function(e) {
                        ...
                        completeLoad: function(e) {
                            ...
                            if (q.defQueueMap = {},
                            n = getOwn(M, e), !t && !hasProp(k, e) && n && !n.inited) {
                        ...
                        onScriptError: function(e) {
                            ...
                            if (!i(t.id)) {
                                ...
                                return eachProp(M,
                                function(e, n) {
                                    0 !== n.indexOf("_@r") && each(e.depMaps,
                                    function(e) {
                                        if (e.id === t.id) return r.push(n),
                                        !0
                                    })
                                }),
                ...
                if ("undefined" == typeof define) {
                    ...
                    req = requirejs = function(e, t, r, n) {
                        ...
                        return isArray(e) || "string" == typeof e || (o = e, isArray(t) ? (e = t, t = r, r = n) : e = []),
                    ...
                    req.load = function(e, t, r) {
                        var n, i = e && e.config || {};
                        if (isBrowser) return n = req.createNode(i, t, r),
                        n.setAttribute("data-requirecontext", e.contextName),
                        n.setAttribute("data-requiremodule", t),
                        !n.attachEvent || n.attachEvent.toString && n.attachEvent.toString().indexOf("[native code") < 0 || isOpera ? (n.addEventListener("load", e.onScriptLoad, !1), n.addEventListener("error", e.onScriptError, !1)) : (useInteractive = !0, n.attachEvent("onreadystatechange", e.onScriptLoad)),
                        n.src = r,
                    ...
                    define = function(e, t, r) {
                        ...
                        !t && isFunction(r) && (t = [], r.length && (r.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp,
                        function(e, r) {
                            t.push(r)
                        }), t = (1 === r.length ? ["require"] : ["require", "exports", "module"]).concat(t))),
                        useInteractive && (n = currentlyAddingScript || getInteractiveScript(), n && (e || (e = n.getAttribute("data-requiremodule")), i = contexts[n.getAttribute("data-requirecontext")])),
                        i ? (i.defQueue.push([e, t, r]), i.defQueueMap[e] = !0) : globalDefQueue.push([e, t, r])
                    },
                    define.amd = {
                        jQuery: !0
                    },
    ...
    AMapUI.define("polyfill/require/require",
    function() {}),
    AMapUI.define("polyfill/require/require-css/css", [],
    function() {
        ...
        h = function(t, r) {
            ...
            if (i.type = "text/css", i.rel = "stylesheet", n) i.onload = function() {
                ...
                for (var e = 0; e < document.styleSheets.length; e++) {
                    ...
                    if (t.href == i.href) return clearInterval(o),
                    r()
                }
            },
            10);
        ...
        i.load = function(e, t, n, i) { (r ? l: h)(t.toUrl(e + ".css"), n)
        },
        i
    }),
    AMapUI.define("polyfill/require/require-css/normalize", [],
    function() {
        function e(e, n, i) {
    ...
    AMapUI.define("polyfill/require/require-text/text", ["module"],
    function(e) {
        "use strict";
        function t(e, t) {
        ...
        return n = {
            ...
            parseName: function(e) {
                ...
                return o !== -1 && (!a || o > 1) ? (t = e.substring(0, o), r = e.substring(o + 1)) : t = e,
                n = r || t,
                o = n.indexOf("!"),
                o !== -1 && (i = "strip" === n.substring(o + 1), n = n.substring(0, o), r ? r = n: t = n),
                {
                    moduleName: t,
                    ext: r,
                    strip: i
            ...
            load: function(e, t, r, i) {
                ...
                s = t.toUrl(a),
                u = g.useXhr || n.useXhr;
                return 0 === s.indexOf("empty:") ? void r() : void(!p || u(s, d, l, h) ? n.get(s,
                function(t) {
        ...
        "node" === g.env || !g.env && "undefined" != typeof process && process.versions && process.versions.node && !process.versions["node-webkit"] && !process.versions["atom-shell"] ? (i = require.nodeRequire("fs"), n.get = function(e, t, r) {
            ...
            u = "";
            try {
                for (r = new java.lang.StringBuffer, n = s.readLine(), n && n.length() && 65279 === n.charAt(0) && (n = n.substring(1)), null !== n && r.append(n); null !== (n = s.readLine());) r.append(a),
                r.append(n);
                u = String(r.toString())
            } finally {
                s.close()
    ...
    AMapUI.define("polyfill/require/require-json/json", ["text"],
    function(text) {
        ...
        return {
            load: function(e, t, r, n) {
                n.isBuild && (n.inlineJSON === !1 || e.indexOf(CACHE_BUST_QUERY_PARAM + "=") !== -1) || 0 === t.toUrl(e).indexOf("empty:") ? r(null) : text.get(t.toUrl(e),
                function(t) {
                    var i;
                    if (n.isBuild) buildMap[e] = t,
                    r(t);
                    else {
                        try {
                            i = jsonParse(t)
    ...
    function() {
        ...
        utils = {
            ...
            mergeArray: function(target, source) {
                ...
                len = source.length; i < len; i += 1) target.push(source[i]);
            },
            ...
            domReady: function(callback) { / complete | loaded | interactive / .test(document.readyState) ? callback() : document.addEventListener("DOMContentLoaded",
                function() {
                    callback();
                },
                !1);
            ...
            forEach: function(array, callback, thisArg) {
                ...
                for (var i = 0,
                len = array.length; i < len; i++) callback.call(thisArg, array[i], i);
            },
            keys: function(obj) {
            ...
            nestExtendObjs: function(dst, objs) {
                ...
                len = objs.length; i < len; i++) {
                    var source = objs[i];
                    if (source) for (var prop in source) source.hasOwnProperty(prop) && (utils.isObject(dst[prop]) && utils.isObject(source[prop]) ? dst[prop] = utils.nestExtendObjs({},
                    [dst[prop], source[prop]]) : dst[prop] = source[prop]);
                }
                return dst;
            },
            ...
            subset: function(props) {
                ...
                utils.forEach(Array.prototype.slice.call(arguments, 1),
                function(source) {
            ...
            nextTick: function(f) { ("object" == typeof process && process.nextTick ? process.nextTick: function(task) {
                    setTimeout(task, 0);
                })(f);
            },
    ...
    AMapUI.define("lib/detect-global", ["./utils"],
    function(utils) {
        var global = this;
        return {
    ...
    AMapUI.define("lib/event", ["lib/utils"],
    function(utils) {
        "use strict";
        function Event() {
            this.__evHash = {};
        ...
        utils.extend(Event.prototype, {
            ...
            __multiCall: function(ev, listener, func) {
                ...
                if (evs && evs.length > 1) {
                    for (var i = 0,
                    len = evs.length; i < len; i++) evs[i] && func.call(this, evs[i], listener);
                    return ! 0;
                }
                return ! 1;
            },
    ...
    function(ns, window) {
        ...
        function extendObj(dst) {
            dst || (dst = {});
            arrForEach(Array.prototype.slice.call(arguments, 1),
            function(source) {
                if (source) for (var prop in source) source.hasOwnProperty(prop) && (dst[prop] = source[prop]);
            });
            return dst;
        ...
        if (!isDebugMode) {
            ...
            for (var reqBundles = reqConf.bundles,
            i = 0,
            len = uiMods.length; i < len; i++) {
        ...
        reqConf.urlArgs = function(id, url) {
            ...
            if (0 === id.indexOf("ui/")) {
                var parts = id.split("/"); (3 === parts.length || 4 === parts.length && "main" === parts[3]) && args.push("mt=ui");
        ...
        ns.loadTpl = function(url, data, cb) {
            ns.require(["lib/underscore-tpl", "text!" + getAbsoluteUrl(url)],
